...
namespace Axian.ActorModel.Lesson1
{
    public class BinManagerSpec : AxTestKit
    {
        ...
        //[Fact]
        //public void _03_CaptureRequest_should_forward_request_to_the_bin_and_respond_success()
        //{
        //    IActorRef binManager = DefaultBinManager();
        //    binManager.Tell(new BinManager.CreateBin());
        ...
        //[Fact]
        //public void _04_CaptureRequest_should_not_respond_when_bin_doesnt_exist()
        //{
        //    IActorRef binManager = DefaultBinManager();
        ...
        //[Fact]
        //public void _05_ListRequests_should_forward_request_to_the_bin()
        //{
        //    IActorRef binManager = DefaultBinManager();
        //    binManager.Tell(new BinManager.CreateBin());
        //    var createResponse = ExpectMsg<BinManager.CreateBinResponse>();
        ...
        //[Fact]
        //public void _06_ListRequests_should_not_respond_when_bin_doesnt_exist()
        //{
        //    IActorRef binManager = DefaultBinManager();
